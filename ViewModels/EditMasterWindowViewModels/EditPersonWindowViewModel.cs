...
{
	internal class EditPersonWindowViewModel : EditMasterWindowViewModel<TPerson>
	{
		// ====================================================================
		// コンストラクター
		// ====================================================================
		...
		public override void Initialize()
		{
			...
			{
				_logWriter?.ShowLogMessage(TraceEventType.Error, "人物詳細情報編集ウィンドウ初期化時エラー：\n" + excep.Message);
